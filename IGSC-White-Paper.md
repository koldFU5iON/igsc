...
| Variable | Description | Example Brackets |
|----------|-------------|------------------|
| **Team Size** | Number of people working on the project | 1–5 / 6–20 / 21–80 / 80+ |
| **Ownership** | Studio's relationship to publishers/platforms | Independent / Affiliated / Owned |
| **Funding Source** | Where money comes from (not amounts) | Self-funded / Grant / Publisher / Investor |
...
| **Critical Reception** | Quality recognition | Review score bands |
| **Growth Signals** | Trajectory indicators | Hiring expansion / follow-up funding / sequel greenlit |
...
|------|-----------|------------------------|
| **Micro** | 1–5 | Solo developers, small partnerships, hobbyist-origin studios |
| **Small** | 6–20 | Established small studios, often genre-focused |
...
| Type | Definition |
|------|------------|
| **Independent** | Fully independent; no major publisher or platform controls decisions |
...
| Scope | Indicators |
|-------|------------|
| **Small** | Limited systems, short playtime, focused mechanics |
| **Medium** | Multiple systems, moderate playtime, some polish investment |
...
| Example | IGSC Classification |
|---------|---------------------|
| Solo developer, self-funded, small scope | Micro / Independent / Small |
| 15-person studio with publisher deal, medium scope | Small / Affiliated / Medium |
| 50-person studio, investor-backed, large scope | Mid / Affiliated / Large |
| Platform-owned studio, 200+ team, massive scope | Large / Owned / Massive |

This replaces vague labels with precise, comparable classifications.
...
1. **Studio completes a classification form** with basic information:
   ...
   - Production scope of current/recent project

2. **System assigns classification** based on responses:
   - No sensitive financial disclosure required
   - All inputs are bracketed ranges, not exact figures
   - Process takes under 5 minutes

3. **Studio receives classification badge/certificate**:
   - Digital badge for press kits, websites, social media
   - Verification ID for authenticity
   - Listed in public registry (optional)

4. **Annual update or milestone reclassification**:
   - Studios update classification yearly or after major changes
...
| Required | Optional |
|----------|----------|
| Team size bracket | Company website |
| Ownership type | Recent project(s) |
...
- Investor or publisher names (unless public)
...
**Solution:** Create award categories by IGSC tier:
- Best Micro Studio Game
- Best Small Studio Game
- Best Mid Studio Game
...
**Solution:** Filter and search by IGSC classification:
- "Show me Independent / Small studios with R2+ outcomes"
- "Find Affiliated / Mid studios in [genre]"
...
**Solution:** Define eligibility by IGSC classification:
...
**Solution:** Standardised IGSC classification enables:
...
**Solution:** IGSC classification provides:
- Honest self-assessment
- Benchmark against true peers
- Track growth over time
- Credible positioning for partners
...
- **Annual review** of tier thresholds and definitions
...
- Integrate IGSC classification into developer profiles
- Use for customer segmentation and support tiers
- Enable better analytics and reporting

### Awards and Showcases
- Create fair competition categories by IGSC tier
- Reduce backlash about mismatched entries
- Celebrate excellence within peer groups

### Publishers and Investors
- Segment scouting and discovery
- Benchmark portfolio by IGSC classification
- Identify growth trajectories

### Grant Programmes
- Define clear eligibility criteria using IGSC tiers
- Reduce application mismatch
- Target funding appropriately

### Press and Analysts
- Use consistent IGSC terminology
- Enable meaningful comparison
- Improve industry reporting

### Studios
- Self-classify to establish positioning
- Benchmark against true peers
...
*International Game Studio Classification (IGSC):3.0
**Author:** Devon Stanton
**Date:** November 2025
**License:** CC BY 4.0
...
The video game industry has grown from a niche hobby into a global entertainment sector generating approximately $188 billion annually (Newzoo, 2024). Yet despite this maturation, the industry lacks fundamental infrastructure that other creative sectors take for granted: a standardised way to classify and compare studios.

Film has its budget tiers and production categories. Music has major labels, independent labels, and self-released artists with clear distinctions. Publishing distinguishes between the Big Five, mid-size houses, and small presses. The game industry, by contrast, relies on vague, culturally-defined terms that emerged organically and have never been formalised.

The classification terms emerged at different points: "AAA" first appeared in gaming trade publications in the early 1990s (Video Game History Foundation, 1991), borrowing from financial credit ratings to describe high-budget titles; "indie" emerged as terminology in the late 1990s and early 2000s alongside digital distribution platforms; while "AA" arose in the early 2010s as a middle-ground classification (Orland, 2024). Initially useful shorthand, these labels have become increasingly inadequate as the industry has diversified. A solo developer working from their bedroom, a 30-person studio with venture capital backing, and a 15-person team bootstrapping their first commercial release might all describe themselves as "indie," despite having fundamentally different resources, constraints, and contexts.
